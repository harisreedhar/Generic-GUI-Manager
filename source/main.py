...
class App:
    ...
    def frameA(self):
        ...
        optionMenu["menu"].config(**self.theme.settings.get('menu'), borderwidth=0)
    ...
    def frameD(self):
        ...
        runButton = tk.Button(frame, width=self.theme.runButtonWidth, borderwidth=0)
    ...
    def breaker(self):
        breaker = tk.Label(self.root, text="_____"*15, **theme.settings.get("breaker"))
    ...
    def createInput(self, frame, index=0, name="", type="STRING", value=None):
        ...
        if type == "FILE":
            ...
            menu["menu"].config(**self.theme.settings.get('menu'), borderwidth=0)
            ...
            pass
        if type != "LIST":
            field = tk.Entry(frame, textvariable=text, width=self.theme.fieldWidth, borderwidth=0)
